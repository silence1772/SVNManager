...
public class Page2 extends Group {
	...
	/** 字体 */
	private Font font = Font.loadFont(Page2.class.getResource("/resources/msyh.ttf").toExternalForm(), 20);
	/** svn工具类 */
		...
		for (int i = 0; i < 53; i++) {
			...
			for (int j = 0; j < d; j++) {
				...
				rectangle.setOnMouseEntered(e -> {
					tip.setLayoutX(e.getSceneX() - 50 - 190);
	...
	protected void drawStaticUI2() {
		...
		score = new Text();
		score.setFont(Font.loadFont(Page2.class.getResource("/resources/msyh.ttf").toExternalForm(), 50));
	...
	protected void drawStaticUI5() {
		Rectangle tip1 = new Rectangle(190, 36, Color.rgb(0, 0, 0, 0.7));
