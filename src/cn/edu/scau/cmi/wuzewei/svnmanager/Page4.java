...
public class Page4 extends Group {
	...
	protected void drawStaticUI1() {
		...
		//resetButton.setLayoutY(150); //适应win7
		resetButton.setLayoutY(160); //适应win10
		resetButton.getStyleClass().add("btn1");

		connectButton = new Button("连接");
		connectButton.setLayoutX(480);
		//connectButton.setLayoutY(150); //适应win7
		connectButton.setLayoutY(160); //适应win10
		connectButton.getStyleClass().add("btn1");

		saveConfigButton1 = new Button("保存");
		saveConfigButton1.setLayoutX(560);
		//saveConfigButton1.setLayoutY(150); //适应win7
		saveConfigButton1.setLayoutY(160); //适应win10
		...
		flowPane.setHgap(10);
		flowPane.setVgap(5);
		//flowPane.setPrefWidth(500); //适应win7
		flowPane.setPrefWidth(550); //适应win10
		...
		//saveConfigButton2.setLayoutX(495); //适应win7
		//saveConfigButton2.setLayoutY(330);
		saveConfigButton2.setLayoutX(520);
		saveConfigButton2.setLayoutY(360);
		...
		//addName.setLayoutX(128); //适应win7
		//addName.setLayoutY(590);
		addName.setLayoutX(148);
		addName.setLayoutY(620);

		addCode = new TextField();
		addCode.setMaxWidth(CodeCol.getPrefWidth());
		addCode.setPromptText("专业代码");
		//addCode.setLayoutX(260); //适应win7
		//addCode.setLayoutY(590);
		addCode.setLayoutX(280);
		addCode.setLayoutY(620);

		tip_text = new Text("");
		tip_text.setFill(Color.rgb(130, 130, 135));
		//tip_text.setLayoutX(128); //适应win7
		//tip_text.setLayoutY(630);
		tip_text.setLayoutX(360);
		tip_text.setLayoutY(610);

		addButton = new Button("新添");
		addButton.getStyleClass().add("btn1");
		//addButton.setLayoutX(340); //适应win7
		//addButton.setLayoutY(588);
		addButton.setLayoutX(360);
		addButton.setLayoutY(618);

		deleteButton = new Button("删除");
		deleteButton.getStyleClass().add("btn1");
		//deleteButton.setLayoutX(420); //适应win7
		//deleteButton.setLayoutY(588);
		deleteButton.setLayoutX(440);
		deleteButton.setLayoutY(618);
